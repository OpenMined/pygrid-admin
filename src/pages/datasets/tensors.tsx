...
const Tensors = () => {
  ...
  const {isLoading, data, error} = useQuery<PyGridTensor[]>('/data-centric/tensors')
  const {isLoading: isLoadingRequests, data: requests} = useQuery<PyGridRequest[]>('/data-centric/requests')
  // TODO: Load settings
  const settings = null

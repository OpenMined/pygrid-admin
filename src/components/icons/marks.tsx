...
const CloseCircle: FunctionComponent<{className: string}> = ({className}) => (
  <svg
    aria-hidden="true"
    focusable="false"
    role="img"
...
const Ban: FunctionComponent<{className: string}> = ({className}) => (
  <svg
    aria-hidden="true"
    focusable="false"
    role="img"
...
const CheckCircle: FunctionComponent<{className: string}> = ({className}) => (
  <svg
    aria-hidden="true"
    focusable="false"
    role="img"
